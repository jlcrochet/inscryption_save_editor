    ...
    <template v-else-if=saveFile>
      <p>
        <form name=main @submit.prevent=createFile>
          <tabs>
            <tab title="Global">
              <forms-global :save-file=saveFile :game-data=gameData />
            </tab>

            <tab title="Part One">
              <forms-part-one :save-file=saveFile :game-data=gameData />
            </tab>

            <tab title="Part Two">
              <forms-part-two :save-file=saveFile :game-data=gameData />
            </tab>

            <tab title="Part Three">
              <forms-part-three :save-file=saveFile :game-data=gameData />
            </tab>

            <tab title="Part Four">
              <forms-part-four :save-file=saveFile :game-data=gameData />
            </tab>
